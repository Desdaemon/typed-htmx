...
declare namespace JSX {
	...
	interface HtmlTag {
		 ...
		 * @note `morph` swaps are part of the [idiomorph] extension.
		 * @note `morphdom` swaps are part of the [morphdom] extension.
		 *
		 * [idiomorph]: https://github.com/bigskysoftware/idiomorph#htmx
		 * [morphdom]: https://htmx.org/extensions/morphdom-swap/
		 */
		 ...
		 * @see {@link HtmxExtensions} for how to declare extensions in JSX.
		 */
		["hx-ext"]?: HtmxExtensions[keyof HtmxExtensions] | "ignore:" | AnyStr;
		/**
